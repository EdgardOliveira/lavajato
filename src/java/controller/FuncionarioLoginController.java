...
public class FuncionarioLoginController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int id = funcionarioDAO.efetuarLogin(usuario, senha);
     ...
     */
    public static java.sql.Date formatarData(String data) throws Exception {
